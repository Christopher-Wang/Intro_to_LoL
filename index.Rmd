...
This, not to mention potential role allocations, item builds, skill interactions means that there can be a 
...
There are many concepts that must first be learned before an evolving game, with frequent patches that occur roughly every two weeks. As a result, it can be challenging to find information 

As a long time player of the game I've found that year over year it has become more difficult to keep up. 
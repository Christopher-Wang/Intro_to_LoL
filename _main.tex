...
\title{Introduction to League of Legends}
...
\hypersetup{
  pdftitle={Introduction to League of Legends},
  pdfauthor={Christopher Wang},
  hidelinks,
...
League of Legends is a popular \emph{Massively Online Battle Arena} or \emph{MOBA} style game that has seen a continual growth in both playerbase as well as game complexity. This text serves as an introduction to some of the common terms and mechanics of the game. Within it you will find descriptions of basic terms such as \emph{minion} or \emph{gold} as well as advanced mechanics such as \emph{lane states}.
